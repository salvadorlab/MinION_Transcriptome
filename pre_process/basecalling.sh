...
# input="/scratch/rx32940/minION/MinION.Fast5.Data/PolyA_cDNA_FAST5_Pass"
# output="/scratch/rx32940/minION/Guppy/PolyA_cDNA_FAST5_Pass"

# guppy_basecaller -x "cuda:0"  --compress_fastq --input_path $input --save_path $output --config dna_r9.4.1_450bps_hac.cfg --fast5_out –cpu_threads_per_caller 5 --num_callers 1
