...
polya_tail_file=sys.argv[1]
polya_tail_anot=sys.argv[2]
gff_file=sys.argv[3]
...
# polya_tail_file=os.path.join(map_path, "Patoc_Basecalled_Aug_16_2019_Direct-cDNA_NoPolyATail.bed")
# polya_tail_anot=os.path.join(polya_path, "Patoc_Basecalled_Aug_16_2019_Direct-cDNA_NoPolyATail.anot.bed")
...
with open(polya_tail_file) as infile, open(polya_tail_anot, "w+") as outfile:
    for line in infile:
        line=line.strip("\n")
        ln_ls=line.split("\t")
        map_chrom=ln_ls[0]
