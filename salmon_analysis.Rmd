...
salmon.deseq <- DESeq(ddsTxi, test="LRT", reduced = "~samples")
...
plotCounts(ddsTxi,"gene-LIC_RS13855", main="PNPase(gene-LIC_LIC_RS13855)")
```
...
locus_names <- unique(cdna.top10.cov.transcript$match_locus)
